...
import XyzBank.Base.BaseSeleniumPage;
...
public class PersonalAreaPage extends BaseSeleniumPage {
    ...
    public void createReportExcel() throws IOException {
        ...
        Sheet newSheet = workbook.createSheet("Новый лист");
        ...
        cellStyle.setDataFormat(createHelper.createDataFormat().getFormat("dd MMMM yyyy HH:mm:ss"));

        Row rowDebit = newSheet.createRow(3);
        Cell cellDebitDate = rowDebit.createCell(0);
        cellDebitDate.setCellStyle(cellStyle);
        cellDebitDate.setCellValue(getTextDebitDataTimeCell());
        ...
        FileOutputStream fileOut = new FileOutputStream("D:\\java_project\\Test\\src\\test\\ExcelFiles\\excelReport.xlsx");
