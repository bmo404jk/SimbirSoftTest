...
import XyzBank.Base.BaseSeleniumTest;
import XyzBank.Pages.CustomerLoginPage;
import XyzBank.Pages.PersonalAreaPage;
...
public class MainTests extends BaseSeleniumTest {
    ...
    @Attachment(value = "Заголовок вложения", type = "xlsx")
    public static byte[] sendBytes(String resourceName) throws IOException {
        return Files.readAllBytes(Paths.get("src/test/ExcelFiles",resourceName));
    }
   ...
   @Test
    public void mainTests() throws IOException, ParseException {
